...
public class AprilTagWebcam {
    private AprilTagProcessor aprilTageProcessor;
    ...
    public void init(HardwareMap hwMap, Telemetry telemetry){
        ...
        aprilTageProcessor = new AprilTagProcessor.Builder()
                .setDrawTagID(true)
                .setDrawTagID(true)
                .setDrawAxes(true)
        ...
        builder.addProcessor((aprilTageProcessor));

        visionPortal = builder.build();
    }

    public void update() {
        detectedTags = aprilTageProcessor.getDetections();
    }
    ...
    public AprilTagDetection getTagBySpecifcId(int id) {
